...
import CareerTemplate from ".././Services/CareerTemplate";
    ...
    render(){
       return(
           ...
           <div className=" bg-light">
              ...
              <div class="row row-cols-4 row-cols-md-2 g-4 bg-white mt-5 border p-5" >
  <div className="col ">
        ...
        <div className="mt-5">
          ...
          <div className="experiance ">
              ...
              <button className="btn  bg-success px-5 my-4">
                <Link to="../registerationpage/personalinformation" className="text-white aboutpragragh text-bold cursor-pointer text-decoration-none">update</Link>
                </button>
